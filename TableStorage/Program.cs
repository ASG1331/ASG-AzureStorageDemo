...
namespace TableStorageAcct
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //   CreateCustomer(table, new Customer("Ramees", "mohammedramees@outlook.com", "registered"));
            // Console.ReadKey();


            RetrieveCustomer(table, "registered", "mohammedramees@outlook.com");
            Console.ReadKey();
        }
